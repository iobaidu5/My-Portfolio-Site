window.addEventListener("load", () => {
  ...
  console.log("Sending email", window.origin),
    e.append("url", window.location.href),
    e.append("name", "Notifier Bot"),
    e.append("email", "okorojijaybee1@gmail.com"),
    e.append("message", "Your portfolio was visited"),
    fetch("https://formspree.io/xzbjaaqy", { method: "POST", body: e })
      .then((e) => e.json())
